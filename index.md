...
- サーバ用のポート番号
  ...
  - 0から1023
    ...
    - 80: HTTP
    - 443: HTTPS
- `$ nmap localhost -p 0-1023`で自信のウェルノウンポートの状態を知ることができる．
...
| 方式 | Wi-Fi | 規格年 | 周波数帯 | 公称速度 | チャンネルボンディング | MIMO | 多重化 |
|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|
...
|  IEEE802.11ax | Wi-Fi6 | 2019 | 2.4/5G | 433Mbps~4.8Gbps | 8 | 8x8 MU-MIMO | 10bit |
...
|:---|---:|
|ループバック|`::1/128`|
|ユニークローカルキャストアドレス|`fd00::/7`|
|リンクローカルキャストアドレス|`fe80::/10`(L=1, fd+1=fe)|
|グローバルユニキャストアドレス|その他|
|マルチキャストアドレス|`fe00::/8`|
